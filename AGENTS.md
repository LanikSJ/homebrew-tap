...
homebrew-tap contains custom Homebrew formulas and casks.

## Code Standards and Practices

### Formula Standards

- Follow Homebrew formula DSL conventions.
- Implement proper dependency declarations.
- Include bottle declarations for common platforms.
- Test formula installations across different macOS versions.

### Documentation Standards

- Include clear installation instructions for each formula/cask.
- Document formula options, dependencies, and conflicts.
- Provide version update procedures.
...
- Update documentation when adding new formulas or modifying existing ones
- Test formula installations and functionality
- **Always run markdownlint and fix all issues in markdown files before considering changes complete**
- **Only make file changes - do not automatically commit changes unless explicitly requested**
- **Use Angular-style commit messages when committing changes**

### Homebrew Standards

- Maintain compatibility with current Homebrew versions
- Implement proper resource and bottle handling
- Follow Homebrew naming and organizational conventions
- Test formulas across different macOS architectures
